...
public class AuthorHibernateDAO implements AuthorDAO {
  ...
  public List<AuthorStats> authorStats() {
    return this.sessionFactory.getCurrentSession().createSQLQuery("select a.author as authorName, count(a.author) as articleCount from articles a group by a.author")
